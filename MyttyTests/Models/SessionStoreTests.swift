...
final class SessionStoreTests: XCTestCase {
  ...
  func test_paneCommandResult() {
    ...
    pane.lastCommandResult = MyttyPane.CommandResult(exitCode: 0, duration: 1_000_000_000)
    XCTAssertEqual(pane.lastCommandResult?.exitCode, 0)
    XCTAssertEqual(pane.lastCommandResult?.duration, 1_000_000_000)
    pane.lastCommandResult = MyttyPane.CommandResult(exitCode: 1, duration: 500_000_000)
